...
export const actions = {
  deploy: async ({ request }) => {
    ...
    try {
      ...
      return { success: true, txid: deployTx.id, unlockSuccess: false }; // Added unlockSuccess property
    } catch (error: any) {
      return { success: false, txid: error.message, unlockSuccess: false };
    }
  },
  ...
  unlock: async ({ request }) => {
    ...
    try {
      ...
      return { success: true, txid: callTx.id, unlockSuccess: true }; // Added unlockSuccess property
    } catch (error: any) {
